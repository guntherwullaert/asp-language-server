...
export async function activate(context: ExtensionContext) {
  ...
  const traceOutputChannel = window.createOutputChannel("ASP Language Server trace");
  const command = process.env.SERVER_PATH || "asp-language-server";
  ...
  client = new LanguageClient("asp-language-server", "ASP language server", serverOptions, clientOptions);
